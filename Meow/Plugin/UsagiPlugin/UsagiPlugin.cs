...
public class UsagiPlugin : PluginBase
{
    ...
    public override void InjectPlugin(Core.Meow host)
    {
        ...
        host.OnCommandReceived.ObserveOn(ThreadPoolScheduler.Instance).Subscribe(Handle);
    }

    private void Handle((Core.Meow meow, MiraiMsgContainerBase msg, string command, string args) obj)
    {
